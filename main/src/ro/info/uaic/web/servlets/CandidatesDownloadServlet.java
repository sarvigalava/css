 ...
 */
@WebServlet("/files/candidates")
@Component
public class CandidatesDownloadServlet extends HttpServlet
{
    ...
    {
        String csv = fileExportService.export(persistenceService.getAllCandidates());
        ...
        String headerValue = "attachment; filename=candidates.csv";
